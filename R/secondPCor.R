...
#' (2) if they only have one shared neighbour, first order PC and the corresponding p-value is calculated as in \code{\link{firstPCor}} and (3) if they do not connect to the same nodes,
#' the connection and p-value are calculated from the zero order PC (the general correlation).
