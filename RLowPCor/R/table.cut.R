...
#'
#' A top weighted edge, fpr or tpr threshod is used to cut the confusion table output from \link{table.evaluation}. The provided \code{cutoff}.
#' threshold must match to the scales of the \code{cutat} metrices.
#' @param input.table the confusion table output from \link{table.evalution}.
#' @param cutoff the cutoff threshold for top weighted edges, fpr or tpr.
#' @param cutat the options are "top", "fpr" and "tpr", which indicate to cut the confusion table at top weighted edges, fpr or tpr.
#' @return a list of results cantains the cut table, the pAUROC value, pAUPR value, precesion for the remained edges, the corresponding top, fpr, tpr cutoffs
